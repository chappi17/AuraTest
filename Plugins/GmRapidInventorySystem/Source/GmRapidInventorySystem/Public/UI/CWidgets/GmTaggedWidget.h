...
#include "GmTaggedWidget.generated.h"

class UObject;

UCLASS(Abstract, Blueprintable)
class GMRAPIDINVENTORYSYSTEM_API UGmTaggedWidget : public UCommonUserWidget
{
	GENERATED_BODY()

public:

	UGmTaggedWidget(const FObjectInitializer& ObjectInitializer);
